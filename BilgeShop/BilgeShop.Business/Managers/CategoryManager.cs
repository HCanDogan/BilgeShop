...
namespace BilgeShop.Business.Managers
{
    public class CategoryManager : ICategoryService
    {
        ...
        public CategoryManager(IRepository<CategoryEntity> categoryRepository, IProductService productService)
        {
        ...
        public void DeleteCategory(int id)
        {
            ...
            var products = _categoryRepository.GetAll().Where(x => x.Id == id);
