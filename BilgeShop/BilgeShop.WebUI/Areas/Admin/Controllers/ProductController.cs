...
namespace BilgeShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(ICategoryService categoryService, IProductService productService, IWebHostEnvironment environment,IMapper mapper)
        {
        ...
        public IActionResult Edit(int id)
        {
            ...
            var viewModel = _mapper.Map<EditProductDto, ProductFormViewModel>(editProductDto);
